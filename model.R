...
# old ---------------------------------------------------------------------------
model_input <- read_json(config_in, simplifyVector = TRUE)
...
write_json(model_output, model_out, na = "null", auto_unbox=TRUE, digits=17, pretty=TRUE)
model_output_check = json_validate(model_out, model_output_schema_fn)
